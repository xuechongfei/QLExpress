...
public class QvmInstructionVisitor extends QLParserBaseVisitor<Void> {
    ...
    private QLambdaDefinition loopBodyVisitorDefinition(BlockStatementsContext bodyCtx, String scopeName,
        List<QLambdaDefinitionInner.Param> paramsType, ErrorReporter errorReporter) {
        if (bodyCtx == null) {
    ...
    public Void visitFunctionStatement(FunctionStatementContext ctx) {
        ...
        List<QLambdaDefinitionInner.Param> params = formalOrInferredParameterList == null ? Collections.emptyList()
    ...
    public Void visitQlIf(QlIfContext qlIfContext) {
        ...
        List<QLInstruction> thenInstructions =
    ...
    private void newArrWithInitializers(Class<?> componentClz, ArrayInitializerContext arrayInitializerContext) {
        ...
        List<VariableInitializerContext> initializerContexts =
    ...
    private void ifElseInstructions(ErrorReporter conditionReporter, List<QLInstruction> thenInstructions,
        Integer thenTraceKey, List<QLInstruction> elseInstructions, Integer elseTraceKey, int traceKey) {
